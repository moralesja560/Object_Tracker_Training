...
def check_requirements(requirements='requirements.txt', exclude=()):
    ...
    for r in requirements:
        try:
            ...
            print(subprocess.check_output(f"pip install --trusted-host pypi.org --trusted-host pypi.python.org --trusted-host files.pythonhosted.org {e.req}", shell=True).decode())
